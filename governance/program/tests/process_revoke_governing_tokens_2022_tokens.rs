...
async fn test_revoke_community_2022_tokens() {
    ...
    // Act
    governance_test
        .revoke_community_2022_tokens(&realm_cookie, &token_owner_record_cookie)
        .await
        .unwrap();
...
async fn test_revoke_council_2022_tokens() {
    ...
    // Act
    governance_test
        .revoke_council_2022_tokens(&realm_cookie, &token_owner_record_cookie)
        .await
        .unwrap();
...
async fn test_revoke_own_council_2022_tokens() {
    ...
    // Act
    governance_test
        .revoke_governing_tokens_2022_using_instruction(
            &realm_cookie,
